...
public class PizzaForm extends JFrame
{
    ...
    {
    toppingsCB[0] = new JCheckBox("Bolts");
    toppingsCB[1] = new JCheckBox("Nuts");
    toppingsCB[2] = new JCheckBox("Oil");
    toppingsCB[3] = new JCheckBox("Screws");
    toppingsCB[4] = new JCheckBox("Toner");
    toppingsCB[5] = new JCheckBox("Microchips");
}
